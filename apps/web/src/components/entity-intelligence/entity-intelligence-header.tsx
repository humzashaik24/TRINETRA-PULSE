...
// ============================================================
// ENTITY INTELLIGENCE — PAGE HEADER
// ============================================================
...
export function EntityIntelligenceHeader({ title, description, actions }: EntityIntelligenceHeaderProps) {
  const now = new Date();
    ...
    >
      <div className="flex flex-col gap-1 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="text-body text-foreground-muted mt-1">{description}</p>
        </div>
