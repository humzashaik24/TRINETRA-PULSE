...
describe('WorkspaceShell — responsive', () => {
  ...
  it('renders the inspector as an overlay drawer at 1023px (tablet breakpoint)', async () => {
    (window as Window & { innerWidth: number }).innerWidth = 1023;
    renderShell();
  ...
  it('renders the inspector as an in-flow panel at 1024px (desktop breakpoint)', async () => {
  ...
  it('renders the inspector as an in-flow panel at 1280px (desktop)', async () => {
  ...
  it('renders the inspector as an in-flow panel at 1440px (desktop)', async () => {
    (window as Window & { innerWidth: number }).innerWidth = 1440;
    renderShell();
